...
import { Trash2, Search, ShieldCheck, ShieldOff } from "lucide-react";
import { useBlockedSites, type BlockedSite } from "@/hooks/use-blocked-sites";
import { AddSiteDialog } from "@/components/blocked-sites/add-site-dialog";
import { BlockConfigDialog } from "@/components/blocked-sites/block-config-dialog";
import { blockModeOptions } from "@/components/blocked-sites/block-mode-fields";
                  ...
                  return (
                    <TableRow key={site.id} className="group">
                      ...
                      <TableCell className="hidden sm:table-cell">
                        <Badge
                          variant="outline"
                          className={`text-xs ${categoryColors[site.category] ?? categoryColors["Other"]}`}
                        >
                          {site.category}
                        </Badge>
                      </TableCell>
                          ...
                          >
                            ...
                            <DialogContent>
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  This will remove{" "}
                                  <strong>{site.domain}</strong> from your block
